...
public class LinkedList<Element>: CustomStringConvertible {
    ...
    /// - Complexity: O(n)
    private func nodeAtIndex(_ index: Int) -> LinkedListNode<Element>? {
...
func assertTrue(_ assertion: Bool) -> String { return assertion ? "✅" : "❌" }
...
ll5.insert(element: 100, atIndex: 0)
assertTrue(ll5.toArray() == [100, 1, 2, 3, 4, 5])

ll5.insert(element: 200, atIndex: 4)
assertTrue(ll5.toArray() == [100, 1, 2, 3, 200, 4, 5])

ll5.insert(element: 300, atIndex: 7)
